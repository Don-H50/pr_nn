...
# fdPcap = open("../../data/traffic_classification/train/qq_file_txt_oflow.pcap", "r")
fdPcap = open("../../data/traffic_classification/train/t.txt", "rb")
print(fdPcap)

Pcapdata = fdPcap.read()
Pcapdata = Pcapdata[0:1500]

print(Pcapdata)
print(len(Pcapdata))

temp = list(Pcapdata)
Pcapdata_array = np.array(temp).reshape(1, -1)
print(temp)
print(type(temp))
print("===========\n", Pcapdata_array)
print(type(Pcapdata_array))

to_tensor = torchvision.transforms.ToTensor()
# re_size = torchvision.transforms.Resize()
re_Pcap = to_tensor(Pcapdata_array).float()
# re_Pcap = torch.reshape(re_Pcap, (1, -1))
print("===========\n", re_Pcap)
print(re_Pcap.shape)

dpc = DeepPacketCNN(n_classes=10)
outputs = dpc(re_Pcap)
print(outputs)
